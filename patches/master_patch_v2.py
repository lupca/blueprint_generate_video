...
# Reconstruct the full LTXV block with channel detection
ltxv_full_block = [
...
# Find and remove old LTXV block
new_lines = []
skip = False
for line in lines:
    if '#lightricks ltxv' in line or 'LTXV detected by' in line:
        skip = True
        continue
...
if top_idx != -1:
    ...
    print('Master Patch V2: LTXV restored with Channel Detection')
else:
